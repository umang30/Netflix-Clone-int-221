...
<div class="main_content">
    <img src="{{$img}}" alt="" class="userprofile">
    <form action="" method="post" class="changeImage" enctype="multipart/form-data">
        @csrf
        <input type="file" name="image">
        <input type="submit" name="submit" value="{{__('language.changePicture')}}" class="button_login">
    </form>
    <H1>{{__('language.yourEmail')}}: {{$email}}</H1>
    @if(isset($message))
