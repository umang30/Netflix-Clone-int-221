...
<body>
    <header>
        ...
        <a href="login" class="loginBtn">{{__('language.signInBtn')}}</a>
    </header>
    <div class="container">
        <div class="main">
            <div class="first">
                <img src="/imgs/Devices.png" alt="" class="devices">
                <h6>{{__('language.step')}} <b>1/3</b></h6>
                <h1>{{__('language.register1')}}</h1>
                <p>{{__('language.register2')}}</p>
                <button class="btn" onclick="openSecond()">{{__('language.next')}}</button>
            </div>
            <div class="second">
                <h6>{{__('language.step')}} <b>1/3<b></h6>
